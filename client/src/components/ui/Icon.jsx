// Lightweight inline SVG icon set (Heroicons outline style — MIT)
const PATHS = {
  target: (
    <>
  ...
  dollar: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-2.21 0-4-1.79-4-4 0-1.094.547-2.094 1.434-2.7M12 6V4.5m0 1.5C13.768 6 14.964 6.781 15.121 7.84M9 18.182l-.879.659C7.121 19.061 5.534 19.061 4.879 18.182m12.121 0l-.879-.659c-1.171-.879-1.171-2.303 0-3.182C16.464 13.781 17.232 13.5 18 13.5c2.21 0 4-1.79 4-4 0-1.094-.547-2.094-1.434-2.7" />
  ),
  sun: (
  ...
  slidersV: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 13.5V3.75m0 9.75a1.5 1.5 0 010 3m0-3a1.5 1.5 0 000 3m0 3.75v-3.75m0-9.75v3m0 0a1.5 1.5 0 010 3m0-3a1.5 1.5 0 000 3M12 3.75v6m0 0a1.5 1.5 0 010 3m0-3a1.5 1.5 0 000 3m0 0v6.75m0-6.75a1.5 1.5 0 010 3m0-3a1.5 1.5 0 000 3M18 3.75v6.75m0 0a1.5 1.5 0 010 3m0-3a1.5 1.5 0 000 3m0 0v6m0-6a1.5 1.5 0 010 3m0-3a1.5 1.5 0 000 3" />
  ),
  chevronDown: (
